...
class Grid:
    ...
    def update_H(self):
        ...
        curl = curl_E(self.E)  # assume this returns Autograd-friendly array/tracer

        # Avoid in-place subtraction (self.H -= ...)
        # Instead do out-of-place update with no mutation:
        self.H = self.H - self.courant_number * self.inverse_permeability * curl
